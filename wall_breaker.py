...
class Paddle:
   ...
   def create_paddle(self):
       ...
       self.paddle = [self.x1, self.y,  self.x2, self.y,          
                      self.x2, self.y+10,  self.x1, self.y+10]     
   ...
   if not Game.OVER:
       if not Game.PAUSE:
           ...
           if key == b' ' and not paddle.shot:
               paddle.shot = True
               paddle.sanity = paddle.x1 + (paddle.width//2) + paddle.shift_x   
